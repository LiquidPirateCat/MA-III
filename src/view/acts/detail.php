...
<div class="foto-container-acts detail-img" style="background-image: url(<?php echo "./" . $act['img'];?>)"></div>
  ...
  <p class="detail-beschrijving txt">Ogen trekken aan je voorbij. De onderzoekers van deze planeet zijn vreemd, grappig en angstaanjagend.</p>
  <a href="www.closeacttheater.com" class="link detail-website txt">www.closeacttheater.com</a>
  ...
  <p class="detail-locatie titel gray">Oud atletiekplein</p>
  <p class="detail-uur titel">18u30</p>
  </article>
