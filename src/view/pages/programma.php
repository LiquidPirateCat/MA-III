...
<?php foreach($acts as $act): ?>
  ...
  <img class="act-datum <?php if($act['uur'] == "Doorlopend"){ echo "act-geen-tijd"; }?> " src="./assets/img/datum.png" alt="datum" width="90" height="90">
